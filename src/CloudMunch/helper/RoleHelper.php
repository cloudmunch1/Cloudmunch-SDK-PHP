...
/**
 * Class RoleHelper
 * This is a helper class for roles.
...
class RoleHelper {
 ...
 public function isRoleNameUnique($existingRoles, $roleName) {
  foreach ( $existingRoles as $value ) {
 ...
 function getRole($roleID, $filterdata) {
  ...
  $serverurl = $this->appContext->getMasterURL () . static::APPLICATIONS . $this->appContext->getProject () . static::TIERS . $roleID;
  $roleArray = $this->cmDataManager->getDataForContext ( $serverurl, $this->appContext->getAPIKey (), $querystring );
